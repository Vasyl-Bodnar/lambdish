...
(function(globalThis){
   ...
   var
    ...
    _h_ = "\\n",
    _i_ = "\\r",
    _m_ = "Bytes.of_seq: cannot grow bytes",
    _l_ = "String.blit / Bytes.blit_string",
    _k_ = "Bytes.blit",
    _j_ = "String.sub / Bytes.sub",
    _p_ = "String.contains_from / Bytes.contains_from",
    _o_ = cst$0,
    _n_ = "String.concat",
    _s_ = "Array.blit",
    _t_ = "Buffer.add: cannot grow buffer",
    _C_ = "%c",
    _D_ = "%s",
    _E_ = cst_i,
    _F_ = cst_li,
    ...
    _R_ = "%r",
    _S_ = "%_r",
    _U_ = [0, cst_camlinternalFormat_ml, 850, 23],
    _ad_ = [0, cst_camlinternalFormat_ml, 814, 21],
    _X_ = [0, cst_camlinternalFormat_ml, 815, 21],
    _ae_ = [0, cst_camlinternalFormat_ml, 818, 21],
    _Y_ = [0, cst_camlinternalFormat_ml, 819, 21],
    _af_ = [0, cst_camlinternalFormat_ml, 822, 19],
    _Z_ = [0, cst_camlinternalFormat_ml, 823, 19],
    _ag_ = [0, cst_camlinternalFormat_ml, 826, 22],
    ___ = [0, cst_camlinternalFormat_ml, 827, 22],
    _ah_ = [0, cst_camlinternalFormat_ml, 831, 30],
    _$_ = [0, cst_camlinternalFormat_ml, 832, 30],
    _ab_ = [0, cst_camlinternalFormat_ml, 836, 26],
    _V_ = [0, cst_camlinternalFormat_ml, 837, 26],
    _ac_ = [0, cst_camlinternalFormat_ml, 846, 28],
    _W_ = [0, cst_camlinternalFormat_ml, 847, 28],
    ...
    _bK_ = "Fatal error: out of memory in uncaught exception handler",
    _bJ_ =
      [0,
       [11, cst_Fatal_error_exception, [2, 0, [12, 10, 0]]],
       cst_Fatal_error_exception_s],
    _bH_ = [0, [2, 0, [12, 10, 0]], "%s\n"],
    _bz_ = "Raised at",
    _bA_ = "Re-raised at",
    _bB_ = "Raised by primitive operation at",
    _bC_ = "Called from",
    _bD_ = " (inlined)",
    _bF_ = cst$0,
    _bE_ =
    ...
    _bG_ = [0, [2, 0, [11, " unknown location", 0]], "%s unknown location"],
    _bu_ = "Out of memory",
    _bv_ = "Stack overflow",
    _bw_ = "Pattern matching failed",
    _bx_ = "Assertion failed",
    _by_ = "Undefined recursive module",
    _bq_ = [0, [12, 40, [2, 0, [2, 0, [12, 41, 0]]]], "(%s%s)"],
    _br_ = cst$0,
    _bs_ = cst$0,
    _bt_ = [0, [12, 40, [2, 0, [12, 41, 0]]], cst_s],
    _bn_ = [0, [4, 0, 0, 0, 0], cst_d],
    _bl_ = [0, [3, 0, 0], "%S"],
    _bm_ = "_",
    _bI_ =
      [0,
    ...
    _b0_ = "Hashtbl: unsupported hash table format",
    _bY_ = cst$0,
    _b5_ = cst$3,
    _b6_ = [0, [2, 0, [11, " := ", [2, 0, 0]]], "%s := %s"],
    _b7_ = cst$3,
    _b8_ =
      [0,
       [11, "(\xce\xbb", [2, 0, [11, ". ", [2, 0, [12, 41, 0]]]]],
       "(\xce\xbb%s. %s)"],
    _b9_ = cst$3,
    _b__ = [0, [12, 40, [2, 0, [12, 41, 0]]], cst_s],
    _b$_ = [0, [12, 34, [2, 0, [12, 34, 0]]], '"%s"'],
    _ca_ = [0, 0, 0],
    _cb_ = [0, 0],
    _cc_ = [1, 0],
    _cd_ = [1, 0],
    ...
    _ck_ = [0, [1, 0], 0],
    _cl_ = [0, 0, 0],
    _b1_ = "Lambdish.Parser.Unbalanced_parens",
    _b2_ = "Lambdish.Parser.Unfinished_fun",
    _b3_ = "Lambdish.Parser.Unfinished_str",
    _b4_ = "Lambdish.Parser.Bad_int",
    _co_ = cst_0,
    _cp_ = cst_0,
    _cr_ = [2, cst_f],
    _cq_ = [0, [2, cst_x], 0],
    ...
    _cs_ = [2, cst_f],
    _ct_ = cst_f,
    _cm_ = "Lambdish.Interpreter.Undefined_var",
    _cw_ = "Jsoo_runtime.Error.Exn",
    _cG_ = "<br/>",
    _cF_ = [0, cst_web_main_ml, 48, 17],
    _cE_ = [0, cst_web_main_ml, 43, 17],
    _cD_ = cst$3,
    _cx_ = "Unbalanced Parenthesis",
    _cy_ = "Unfinished Function",
    _cz_ = "Unfinished String",
    _cA_ = "Bad Number",
    _cB_ = "Undefined Variable: ",
    _cC_ = "Unknown Error";
   ...
   function flush_all(param){
    ...
    for(;;){
     ...
     try{caml_ml_flush(a);}
      ...
      var _e3_ = caml_wrap_exception(_e4_);
      if(_e3_[1] !== Sys_error) throw caml_maybe_attach_backtrace(_e3_, 0);
     }
     var param$0 = l;
    }
   }
   ...
   function concat(sep, l){
    ...
    for(;;){
     if(param){
      ...
      var _e2_ = caml_ml_string_length(hd) + acc | 0;
     }
     else
      var _e2_ = acc;
     var dst = caml_create_bytes(_e2_), pos = pos$1, param$0 = l;
     for(;;){
      if(param$0){
       var hd$0 = param$0[1];
       if(param$0[2]){
   ...
   function to_seq(s){
    ...
    function aux(i, param){
     ...
     var x = caml_bytes_get(s$0, i), _e0_ = i + 1 | 0;
     return [0, x, function(_e1_){return aux(_e0_, _e1_);}];
    }
    var _eY_ = 0;
    return function(_eZ_){return aux(_eY_, _eZ_);};
   }
   function of_seq(seq$0){
    ...
    for(;;){
     ...
     if(n[1] === caml_ml_bytes_length(buf[1])){
      ...
      if(caml_ml_bytes_length(buf[1]) === new_len) failwith(_m_);
   ...
   var at_exit_key = new_key(0, function(param, _eX_){return 0;});
   ...
   function string_of_formatting_lit(formatting_lit){
    ...
    switch(formatting_lit[0]){
      ...
      default:
       ...
       return symbol(_B_, caml_string_of_bytes(make(1, c)));
    }
   }
     ...
     switch(param[0]){
       case 0:
        var
         ...
         af = match[2],
         fa = match[1],
         _eA_ = function(param){af(0); return 0;};
        return [0, function(param){fa(0); return 0;}, _eA_, ed, de];
       case 1:
        var
         rest$0 = param[1],
         ...
         af$0 = match$0[2],
         fa$0 = match$0[1],
         _eB_ = function(param){af$0(0); return 0;};
        return [0, function(param){fa$0(0); return 0;}, _eB_, ed$0, de$0];
       case 2:
        var
         rest$1 = param[1],
         ...
         af$1 = match$1[2],
         fa$1 = match$1[1],
         _eC_ = function(param){af$1(0); return 0;};
        return [0, function(param){fa$1(0); return 0;}, _eC_, ed$1, de$1];
       case 3:
        var
         rest$2 = param[1],
         ...
         af$2 = match$2[2],
         fa$2 = match$2[1],
         _eD_ = function(param){af$2(0); return 0;};
        return [0, function(param){fa$2(0); return 0;}, _eD_, ed$2, de$2];
       case 4:
        var
         rest$3 = param[1],
         ...
         af$3 = match$3[2],
         fa$3 = match$3[1],
         _eE_ = function(param){af$3(0); return 0;};
        return [0, function(param){fa$3(0); return 0;}, _eE_, ed$3, de$3];
       case 5:
        var
         rest$4 = param[1],
         ...
         af$4 = match$4[2],
         fa$4 = match$4[1],
         _eF_ = function(param){af$4(0); return 0;};
        return [0, function(param){fa$4(0); return 0;}, _eF_, ed$4, de$4];
       case 6:
        var
         rest$5 = param[1],
         ...
         af$5 = match$5[2],
         fa$5 = match$5[1],
         _eG_ = function(param){af$5(0); return 0;};
        return [0, function(param){fa$5(0); return 0;}, _eG_, ed$5, de$5];
       case 7:
        var
         rest$6 = param[1],
         ...
         af$6 = match$6[2],
         fa$6 = match$6[1],
         _eH_ = function(param){af$6(0); return 0;};
        return [0, function(param){fa$6(0); return 0;}, _eH_, ed$6, de$6];
       case 8:
        var
         rest$7 = param[2],
         ...
         af$7 = match$7[2],
         fa$7 = match$7[1],
         _eI_ = function(param){af$7(0); return 0;};
        return [0, function(param){fa$7(0); return 0;}, _eI_, ed$7, de$7];
       case 9:
        var
         rest$8 = param[3],
         ty2 = param[2],
         ...
         ga = match$9[2],
         ag = match$9[1],
         _eJ_ = function(param){jd(0); de$8(0); return 0;},
         _eK_ = function(param){ed$8(0); dj(0); return 0;},
         _eL_ = function(param){ga(0); af$8(0); return 0;};
        return [0,
       ...
       case 10:
        var
         ...
         af$9 = match$10[2],
         fa$9 = match$10[1],
         _eM_ = function(param){af$9(0); return 0;};
        return [0, function(param){fa$9(0); return 0;}, _eM_, ed$9, de$9];
       case 11:
        var
         rest$10 = param[1],
         ...
         af$10 = match$11[2],
         fa$10 = match$11[1],
         _eN_ = function(param){af$10(0); return 0;};
        return [0, function(param){fa$10(0); return 0;}, _eN_, ed$10, de$10];
       case 12:
        var
         rest$11 = param[1],
         ...
         af$11 = match$12[2],
         fa$11 = match$12[1],
         _eO_ = function(param){af$11(0); return 0;};
        return [0, function(param){fa$11(0); return 0;}, _eO_, ed$11, de$11];
       case 13:
        var
         rest$12 = param[1],
         ...
         af$12 = match$13[2],
         fa$12 = match$13[1],
         _eP_ = function(param){de$12(0); return 0;},
         _eQ_ = function(param){ed$12(0); return 0;},
         _eR_ = function(param){af$12(0); return 0;};
        return [0, function(param){fa$12(0); return 0;}, _eR_, _eQ_, _eP_];
       default:
        var
         rest$13 = param[1],
         ...
         af$13 = match$14[2],
         fa$13 = match$14[1],
         _eS_ = function(param){de$13(0); return 0;},
         _eT_ = function(param){ed$13(0); return 0;},
         _eU_ = function(param){af$13(0); return 0;};
        return [0, function(param){fa$13(0); return 0;}, _eU_, _eT_, _eS_];
     }
         ...
         switch(ty2[0]){
           case 8:
            var
             rest2$7 = ty2[2],
             ty2$0 = ty2[1],
             _ew_ = trans(rest1$7, rest2$7);
            return [8, trans(ty1$0, ty2$0), _ew_];
           case 10: break;
           case 11:
            switch$0 = 1; break;
           case 12:
      ...
      case 14:
       if(typeof fmtty0 !== "number" && 9 === fmtty0[0]){
        var
         ...
         sub_fmtty$1 = fmt[2],
         pad_opt$0 = fmt[1],
         _eu_ = [0, erase_rel(sub_fmtty1)];
        if(caml_notequal([0, erase_rel(sub_fmtty$1)], _eu_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
        ...
        switch(ign[0]){
          ...
          case 9:
           var
            sub_fmtty$3 = ign[2],
            pad_opt$2 = ign[1],
            _ev_ = type_ignored_format_substituti(sub_fmtty$3, rest, fmtty0),
            match$43 = _ev_[2],
            fmtty$21 = match$43[2],
            fmt$22 = match$43[1],
            sub_fmtty$4 = _ev_[1];
      ...
      case 9:
       if(typeof fmtty !== "number" && 9 === fmtty[0]){
        var
         ...
         _es_ = [0, erase_rel(sub1_fmtty)];
        if(caml_notequal([0, erase_rel(sub1_fmtty$0)], _es_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var _et_ = [0, erase_rel(sub2_fmtty$1)];
        if(caml_notequal([0, erase_rel(sub2_fmtty$2)], _et_))
         throw caml_maybe_attach_backtrace(Type_mismatch, 1);
        var
   ...
   function fix_padding(padty, width, str){
    ...
    var _er_ = 2 === padty$0 ? 48 : 32, res = make(width$0, _er_);
    switch(padty$0){
      case 0:
   ...
   function string_to_caml_string(str$0){
    var
     ...
     n = [0, 0],
     _ej_ = caml_ml_bytes_length(b) - 1 | 0,
     _ei_ = 0;
    if(_ej_ >= 0){
     var i$0 = _ei_;
     for(;;){
      ...
      if(32 <= match){
       var _en_ = match - 34 | 0, switch$1 = 0;
       if(58 < _en_ >>> 0){
        if(93 > _en_) switch$1 = 1;
       }
       else if(56 < _en_ - 1 >>> 0) switch$0 = 1; else switch$1 = 1;
       if(switch$1){var _eo_ = 1; switch$0 = 2;}
      }
      else
       if(11 <= match){
      ...
      n[1] = n[1] + _eo_ | 0;
      var _ep_ = i$0 + 1 | 0;
      if(_ej_ !== i$0){var i$0 = _ep_; continue;}
      break;
     }
    }
    if(n[1] === caml_ml_bytes_length(b))
     ...
     n[1] = 0;
     var _el_ = caml_ml_bytes_length(b) - 1 | 0, _ek_ = 0;
     if(_el_ >= 0){
      var i = _ek_;
      for(;;){
   ...
   function transform_int_alt(iconv, s){
    ...
    var n = [0, 0], _ed_ = caml_ml_string_length(s) - 1 | 0, _ec_ = 0;
    if(_ed_ >= 0){
     var i$0 = _ec_;
     for(;;){
      if(9 >= caml_string_unsafe_get(s, i$0) - 48 >>> 0) n[1]++;
      var _eh_ = i$0 + 1 | 0;
      if(_ed_ !== i$0){var i$0 = _eh_; continue;}
      break;
     }
    }
    var
    ...
    var
     ...
     _ef_ = caml_ml_string_length(s) - 1 | 0,
     _ee_ = 0;
    if(_ef_ >= 0){
     var i = _ee_;
     for(;;){
   ...
   function convert_int(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _eb_ = _am_; break;
      default: var _eb_ = _av_;
    }
    return transform_int_alt(iconv, caml_format_int(_eb_, n));
   }
   function convert_int32(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _ea_ = _aM_; break;
      default: var _ea_ = _aV_;
    }
    return transform_int_alt(iconv, caml_format_int(_ea_, n));
   }
   function convert_nativeint(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _d$_ = _aZ_; break;
      default: var _d$_ = _a8_;
    }
    return transform_int_alt(iconv, caml_format_int(_d$_, n));
   }
   function convert_int64(iconv, n){
    switch(iconv){
      ...
      case 14:
       var _d__ = _az_; break;
      default: var _d__ = _aI_;
    }
    return transform_int_alt(iconv, caml_int64_format(_d__, n));
   }
      ...
      case 5:
       ...
       for(;;){
        if(i$0 === len)
         ...
         var _d7_ = caml_string_get(str, i$0) - 46 | 0, switch$0 = 0;
         if(23 < _d7_ >>> 0){
          if(55 === _d7_) switch$0 = 1;
         }
         else if(21 < _d7_ - 1 >>> 0) switch$0 = 1;
         if(! switch$0){var i$1 = i$0 + 1 | 0, i$0 = i$1; continue;}
         var _d8_ = 1;
        }
        var _d9_ = _d8_ ? str : symbol(str, _a9_);
        return caml_special_val(_d9_);
       }
      case 6:
       return hex(0);
      case 7:
       ...
       if(0 === l)
        ...
        var r = caml_create_bytes(l), _d3_ = l - 1 | 0, _d2_ = 0;
        if(_d3_ >= 0){
         var i = _d2_;
         for(;;){
          var
           c = caml_bytes_unsafe_get(s, i),
           _d4_ = 25 < c - 97 >>> 0 ? c : c - 32 | 0;
          caml_bytes_unsafe_set(r, i, _d4_);
          var _d5_ = i + 1 | 0;
       ...
       return caml_string_of_bytes(_d6_);
      case 8:
    ...
    for(;;){
     ...
     switch(fmt$0[0]){
       ...
       case 14:
        ...
        return function(param){
         var
          ...
          _d1_ = type_format_gen(fmt$0, fmtty$0);
         if(typeof _d1_[2] !== "number")
          throw caml_maybe_attach_backtrace(Type_mismatch, 1);
         var fmt = _d1_[1];
       ...
       default:
        ...
        if(counter >= 50)
         return caml_trampoline_return
                 (make_custom$0, [0, k$0, acc$0, rest$23, arity, _d0_]);
        var counter$0 = counter + 1 | 0;
        return make_custom$0(counter$0, k$0, acc$0, rest$23, arity, _d0_);
     }
    }
   }
   ...
   function make_invalid_arg(counter, k, acc, fmt){
    var _dX_ = [8, acc, _bg_];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dX_, fmt]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dX_, fmt);
   }
   function make_custom$0(counter, k, acc, rest, arity, f){
    ...
    var _dW_ = [4, acc, f];
    if(counter >= 50)
     return caml_trampoline_return(make_printf$0, [0, k, _dW_, rest]);
    var counter$0 = counter + 1 | 0;
    return make_printf$0(counter$0, k, _dW_, rest);
   }
   ...
   function fprintf(oc, fmt$0){
    var fmt = fmt$0[1], _dV_ = 0;
    return make_printf
            (function(acc){output_acc(oc, acc); return 0;}, _dV_, fmt);
   }
   ...
   function field(x, i$1){
    ...
    if(! (1 - (typeof f === "number" ? 1 : 0)))
     return caml_call1(sprintf(_bn_), f);
    if(caml_obj_tag(f) === 252) return caml_call1(sprintf(_bl_), f);
    if(caml_obj_tag(f) !== 253) return _bm_;
    var
   ...
   function other_fields(x, i){
    ...
    var _dT_ = other_fields(x, i + 1 | 0), _dU_ = field(x, i);
    return caml_call2(sprintf(_bp_), _dU_, _dT_);
   }
   function to_string(e){
    ...
    for(;;){
     if(param){
      ...
      try{var val = caml_call1(hd, e);}catch(_dS_){switch$0 = 1;}
      var switch$1 = 0;
      if(switch$0 || ! val)
       switch$1 = 1;
      else
     ...
     if(0 === caml_obj_tag(e)){
      ...
      if(2 < match >>> 0)
       var
        _dO_ = other_fields(e, 2),
        _dP_ = field(e, 1),
        _dR_ = caml_call2(sprintf(_bq_), _dP_, _dO_);
      else
       switch(match){
         case 0:
          var _dR_ = _br_; break;
         case 1:
          var _dR_ = _bs_; break;
         default:
          var _dQ_ = field(e, 1), _dR_ = caml_call1(sprintf(_bt_), _dQ_);
       }
      var match$0 = [0, constructor, [0, _dR_]];
     }
     else
      var match$0 = [0, e[1], 0];
     ...
     for(;;){
       ...
       info$0 =
         function(pos){
          function info(is_raise){
           return is_raise ? 0 === pos ? _bz_ : _bA_ : 0 === pos ? _bB_ : _bC_;
          }
          return info;
         },
       info = info$0(pos);
      if(0 === slot[0])
       var
        ...
        _dE_ = slot[4],
        _dF_ = slot[3],
        _dG_ = slot[6] ? _bD_ : _bF_,
        _dH_ = slot[2],
        _dI_ = slot[7],
        _dJ_ = info(slot[1]),
        match =
          [0,
           caml_call7(sprintf(_bE_), _dJ_, _dI_, _dH_, _dG_, _dF_, _dE_, _dD_)];
      else if(slot[1])
       var match = 0;
      else
       var _dK_ = info(0), match = [0, caml_call1(sprintf(_bG_), _dK_)];
      if(match){var str = match[1]; caml_call1(fprintf(outchan, _bH_), str);}
      var _dN_ = pos + 1 | 0;
      if(_dM_ !== pos){var pos = _dN_; continue;}
      break;
     }
    }
    return 0;
   ...
   var errors = _bI_.slice(), empty_backtrace = [0];
   function handle_uncaught_exception(exn$0, debugger_in_use){
    try{
     try{
      ...
      try{do_at_exit(0);}catch(_dB_){}
      try{
       var _dr_ = to_string(exn$0);
       caml_call1(eprintf(_bJ_), _dr_);
       print_raw_backtrace(stderr, raw_backtrace);
       var status = caml_ml_debug_info_status(0);
       if(status < 0){
        var _ds_ = abs(status);
        prerr_endline(caml_check_bound(errors, _ds_)[1 + _ds_]);
       }
       var _dt_ = caml_ml_flush(stderr), _dx_ = _dt_;
      }
      catch(exn$1){
       var
        exn = caml_wrap_exception(exn$1),
        raw_backtrace$0 = caml_get_exception_raw_backtrace(0),
        _dv_ = to_string(exn$0);
       caml_call1(eprintf(_bL_), _dv_);
       print_raw_backtrace(stderr, raw_backtrace);
       var _dw_ = to_string(exn);
       caml_call1(eprintf(_bM_), _dw_);
       print_raw_backtrace(stderr, raw_backtrace$0);
       var _dx_ = caml_ml_flush(stderr);
      }
      var _dy_ = _dx_;
     }
     catch(_dA_){
      var _du_ = caml_wrap_exception(_dA_);
      if(_du_ !== Out_of_memory) throw caml_maybe_attach_backtrace(_du_, 0);
      var _dy_ = prerr_endline(_bK_);
     }
     return _dy_;
    }
    catch(_dz_){return 0;}
   ...
   function set(s, i1, i2, i3, i4){
    ...
    var i3$0 = caml_notequal(i3, _bO_) ? i3 : _bR_;
    caml_ba_set_1(s, 2, i3$0);
    var i4$0 = caml_notequal(i4, _bP_) ? i4 : _bQ_;
   ...
   function make_self_init(param){
    ...
    var
     d2 = bytes(b),
     _dn_ = get_int64_le(d2, 8),
     _do_ = get_int64_le(d2, 0),
     _dp_ = get_int64_le(d1, 8);
    set(s, get_int64_le(d1, 0), _dp_, _do_, _dn_);
    return s;
   }
   function split(s){
    var
   ...
   try{var _cI_ = caml_sys_getenv("OCAMLRUNPARAM"), params = _cI_;}
   catch(_dj_){
    var _bW_ = caml_wrap_exception(_dj_);
    if(_bW_ !== Not_found) throw caml_maybe_attach_backtrace(_bW_, 0);
    try{var _cH_ = caml_sys_getenv("CAMLRUNPARAM"), _bZ_ = _cH_;}
    catch(_dk_){
     var _bX_ = caml_wrap_exception(_dk_);
     if(_bX_ !== Not_found) throw caml_maybe_attach_backtrace(_bX_, 0);
     var _bZ_ = _bY_;
    }
    var params = _bZ_;
   }
   var lim = caml_ml_string_length(params), i$1 = 0;
   if(lim < 0)
    var randomized_default = invalid_arg(_p_);
   else
    try{
     var i = i$1;
     for(;;){
      if(lim <= i) throw caml_maybe_attach_backtrace(Not_found, 1);
      if(caml_string_unsafe_get(params, i) !== 82){var i$0 = i + 1 | 0, i = i$0; continue;}
      var _r_ = 1, randomized_default = _r_;
      break;
     }
    }
    catch(_di_){
     var _q_ = caml_wrap_exception(_di_);
     if(_q_ !== Not_found) throw caml_maybe_attach_backtrace(_q_, 0);
   ...
   var
    Unbalanced_parens = [248, _b1_, caml_fresh_oo_id(0)],
    Unfinished_fun = [248, _b2_, caml_fresh_oo_id(0)],
    Unfinished_str = [248, _b3_, caml_fresh_oo_id(0)],
    Bad_int = [248, _b4_, caml_fresh_oo_id(0)];
   function tok_to_str(param){
    switch(param[0]){
      case 0:
       var
        toks = param[2],
        name = param[1],
        _df_ = concat(_b5_, map(tok_to_str, toks));
       return caml_call2(sprintf(_b6_), name, _df_);
      case 1:
       var
        toks$0 = param[2],
        var$0 = param[1],
        _dg_ = concat(_b7_, map(tok_to_str, toks$0));
       return caml_call2(sprintf(_b8_), var$0, _dg_);
      case 2:
       var var$1 = param[1]; return var$1;
      case 3:
       var toks$1 = param[1], _dh_ = concat(_b9_, map(tok_to_str, toks$1));
       return caml_call1(sprintf(_b__), _dh_);
      case 4:
       var i = param[1]; return "" + i;
      default: var s = param[1]; return caml_call1(sprintf(_b$_), s);
    }
   }
   function parse(sett, param){
    var param$0 = param;
    for(;;){
     if(! param$0) return 0;
     var c = param$0[1];
     if(10 !== c && 32 !== c){
      var
       cs$0 = param$0[2],
       match = expr(sett, [0, c, cs$0]),
       rest = match[2],
       toks = match[1];
      return symbol$0(toks, parse(sett, rest));
     }
     var cs = param$0[2], param$0 = caml_call1(cs, 0);
    }
   }
   function expr(sett, param){
    var param$0 = param;
    for(;;){
     if(! param$0) return _ca_;
     var c = param$0[1];
     if(48 <= c){
      if(92 === c){
       var
        cs = param$0[2],
        _c9_ = lambda(sett, caml_call1(cs, 0)),
        match$1 = _c9_[2],
        rest = match$1[2],
        body = match$1[1],
        name = _c9_[1],
        _c__ = 0;
       return [0,
               [0, [1, of_seq(function(param){return name;}), body], _c__],
               rest];
      }
      if(58 > c){
       var
        cs$2 = param$0[2],
        match$8 = integer(sett, [0, c, cs$2]),
        rest$8 = match$8[2],
        intg = match$8[1],
        xs$3 = function(param){return intg;},
        intg_len = 0,
        xs = xs$3;
       for(;;){
        var match = xs(0);
        ...
        var
         match$9 = expr(sett, rest$8),
         rest$9 = match$9[2],
         toks$1 = match$9[1],
         xs$4 = function(param){return intg;},
         accu$0 = 0,
         i = 0,
         xs$1 = xs$4;
        for(;;){
         var match$0 = xs$1(0);
         if(! match$0) return [0, [0, [4, accu$0], toks$1], rest$9];
         var
          xs$2 = match$0[2],
          x = match$0[1],
          accu$1 =
            accu$0
            + caml_mul(x, Math.pow(10., (intg_len - i | 0) - 1 | 0) | 0)
            | 0,
          i$0 = i + 1 | 0,
          accu$0 = accu$1,
          i = i$0,
      ...
      if(10 === c)
       ...
       switch(c - 32 | 0){
         ...
         case 2:
          var
           cs$4 = param$0[2],
           match$10 = str(sett, caml_call1(cs$4, 0)),
           rest$10 = match$10[2],
           str$2 = match$10[1],
           match$11 = expr(sett, rest$10),
           rest$11 = match$11[2],
           toks$2 = match$11[1];
          return [0,
                  [0, [5, of_seq(function(param){return str$2;})], toks$2],
                  rest$11];
         case 8:
          var
           cs$5 = param$0[2],
           _dd_ = caml_call1(cs$5, 0),
           match$12 = expr([0, sett[1] + 1 | 0, sett[2], sett[3]], _dd_),
           rest$12 = match$12[2],
           toks$3 = match$12[1];
          if(rest$12 && 41 === rest$12[1]){
           var cs$6 = rest$12[2];
           if(0 === sett[1])
            return [0, [0, [3, toks$3], 0], caml_call1(cs$6, 0)];
           if(1 === sett[1]){
            var
             match$13 = expr(sett, caml_call1(cs$6, 0)),
             rest$13 = match$13[2],
             inn_toks = match$13[1];
            return [0, [0, [3, toks$3], inn_toks], rest$13];
           }
           if(1 < sett[1]){
            var
             _de_ = caml_call1(cs$6, 0),
             match$14 = expr([0, sett[1] - 1 | 0, sett[2], sett[3]], _de_),
             rest$14 = match$14[2],
             inn_toks$0 = match$14[1];
            return [0, [0, [3, toks$3], inn_toks$0], rest$14];
           }
          }
          throw caml_maybe_attach_backtrace(Unbalanced_parens, 1);
         case 9:
          var cs$7 = param$0[2];
          if(0 < sett[1]) return [0, 0, [0, 41, cs$7]];
          if(0 === sett[1])
           throw caml_maybe_attach_backtrace(Unbalanced_parens, 1);
          break;
       }
      if(switch$0){
       var cs$3 = param$0[2], param$0 = caml_call1(cs$3, 0);
       continue;
      }
     }
     var cs$0 = param$0[2];
     if(sett[2]){
      var _c$_ = try_lambda(sett, [0, c, cs$0]), match$2 = _c$_[1];
      if(0 === match$2[0]){
       var
        rest$0 = _c$_[2],
        lamb = match$2[1],
        match$3 = expr(sett, rest$0),
        rest$1 = match$3[2],
        body$0 = match$3[1],
        _da_ = 0;
       return [0,
               [0, [1, of_seq(function(param){return lamb;}), body$0], _da_],
               rest$1];
      }
      var
       rest$2 = _c$_[2],
       str$0 = match$2[1],
       match$4 = expr(sett, rest$2),
       rest$3 = match$4[2],
       toks = match$4[1];
      return [0,
              [0, [2, of_seq(function(param){return str$0;})], toks],
              rest$3];
     }
     var
      cs$1 = param$0[2],
      _db_ = try_def(sett)([0, c, cs$1]),
      match$5 = _db_[1];
     if(0 === match$5[0]){
      var
       rest$4 = _db_[2],
       def = match$5[1],
       match$6 = expr(sett, rest$4),
       rest$5 = match$6[2],
       body$1 = match$6[1],
       _dc_ = 0;
      return [0,
              [0, [0, of_seq(function(param){return def;}), body$1], _dc_],
              rest$5];
     }
     var
      rest$6 = _db_[2],
      str$1 = match$5[1],
      match$7 = expr(sett, rest$6),
      rest$7 = match$7[2],
      toks$0 = match$7[1];
     return [0,
             [0, [2, of_seq(function(param){return str$1;})], toks$0],
             rest$7];
    }
   }
   function lambda(sett, param){
    var param$0 = param;
    for(;;){
     if(! param$0) throw caml_maybe_attach_backtrace(Unfinished_fun, 1);
     var c = param$0[1], switcher = c - 10 | 0;
     if(22 < switcher >>> 0){
      if(36 === switcher){
       var cs = param$0[2], _c8_ = caml_call1(cs, 0);
       return [0, 0, expr([0, sett[1], 1, sett[3]], _c8_)];
      }
     }
     else if(20 < switcher - 1 >>> 0){
      var cs$1 = param$0[2], param$0 = caml_call1(cs$1, 0);
      continue;
     }
     var
      cs$0 = param$0[2],
      match = lambda(sett, caml_call1(cs$0, 0)),
      body = match[2],
      name = match[1];
     return [0, [0, c, function(param){return name;}], body];
    }
   }
   function try_lambda(sett, param){
    if(! param) return _ce_;
    var c = param[1];
    if(33 <= c){
     if(42 <= c){
      if(46 === c){var cs = param[2]; return [0, _cb_, caml_call1(cs, 0)];}
     }
     else if(40 <= c){var cs$1 = param[2]; return [0, _cc_, [0, c, cs$1]];}
    }
    else{
     var switch$0 = 0;
     if(10 !== c && 32 > c) switch$0 = 1;
     if(! switch$0){
      var cs$2 = param[2];
      return [0, _cd_, caml_call1(cs$2, 0)];
     }
    }
    var
     cs$0 = param[2],
     match = try_lambda(sett, caml_call1(cs$0, 0)),
     rest = match[2],
     resl = match[1];
    if(0 === resl[0]){
     var lamb = resl[1];
     return [0, [0, [0, c, function(param){return lamb;}]], rest];
    }
    var str = resl[1];
    return [0, [1, [0, c, function(param){return str;}]], rest];
   }
   function try_def(sett){
    function try_match(c, cs){
     var
      _c7_ = caml_call1(cs, 0),
      match = try_def(sett)(_c7_),
      rest = match[2],
      resl = match[1];
     if(0 === resl[0]){
      var def = resl[1];
      return [0, [0, [0, c, function(param){return def;}]], rest];
     }
     var str = resl[1];
     return [0, [1, [0, c, function(param){return str;}]], rest];
    }
    return function(param){
     if(! param) return _ck_;
     var c = param[1];
     if(33 <= c){
      if(42 <= c){
       if(58 === c){
        var cs = param[2], match = caml_call1(cs, 0);
        if(match && 61 === match[1]){
         var cs$0 = match[2];
         return [0, _cf_, caml_call1(cs$0, 0)];
        }
        return try_match(58, cs);
       }
      }
      else if(40 <= c){var cs$2 = param[2]; return [0, _cg_, [0, c, cs$2]];}
     }
     else{
      var switch$0 = 0;
      if(10 !== c && 32 > c) switch$0 = 1;
      if(! switch$0){
       var cs$3 = param[2], xs = cs$3;
       for(;;){
        var node = caml_call1(xs, 0);
        if(node){
         var xs$0 = node[2], x = node[1], switch$1 = 0;
         if(10 !== x && 32 !== x){var _c6_ = 0; switch$1 = 1;}
         if(! switch$1) var _c6_ = 1;
         if(_c6_){var xs = xs$0; continue;}
         var match$0 = node;
        }
        else
         var match$0 = 0;
        if(match$0 && 58 === match$0[1]){
         var pc = match$0[2], match$1 = caml_call1(pc, 0);
         if(match$1 && 61 === match$1[1]){
          var cs$4 = match$1[2];
          return [0, _ch_, caml_call1(cs$4, 0)];
         }
         return [0, _ci_, caml_call1(cs$3, 0)];
        }
        return [0, _cj_, caml_call1(cs$3, 0)];
       }
      }
     }
     var cs$1 = param[2];
     return try_match(c, cs$1);};
   }
   function integer(sett, param){
    if(! param) return _cl_;
    var c = param[1];
    if(33 <= c){
     if(42 <= c){
      if(9 >= c - 48 >>> 0){
       var
        cs = param[2],
        match = integer(sett, caml_call1(cs, 0)),
        rest = match[2],
        intg = match[1];
       return [0, [0, c - 48 | 0, function(param){return intg;}], rest];
      }
     }
     else if(40 <= c){var cs$0 = param[2]; return [0, 0, [0, c, cs$0]];}
    }
    else{
     var switch$0 = 0;
     if(10 !== c && 32 > c) switch$0 = 1;
     if(! switch$0){var cs$1 = param[2]; return [0, 0, caml_call1(cs$1, 0)];}
    }
    throw caml_maybe_attach_backtrace(Bad_int, 1);
   }
   function str(sett, param){
    if(! param) throw caml_maybe_attach_backtrace(Unfinished_str, 1);
    var c = param[1];
    if(34 === c){var cs = param[2]; return [0, 0, caml_call1(cs, 0)];}
    var
     cs$0 = param[2],
     match = str(sett, caml_call1(cs$0, 0)),
     rest = match[2],
     str$0 = match[1];
    return [0, [0, c, function(param){return str$0;}], rest];
   }
   var
    Undefined_var = [248, _cm_, caml_fresh_oo_id(0)],
    random = caml_atomic_load(randomized),
    x = 16,
    _cn_ = 0;
   for(;;){
    if(20 > x && max_array_length >= (x * 2 | 0)){var x$0 = x * 2 | 0, x = x$0; continue;}
    if(random)
     var
      s = get(prng_key),
     ...
     var seed = 0;
    var
     default_modl = [0, [0, 0, caml_make_vect(x, 0), seed, x], _cn_],
     substitute =
       function(var$0, tok, toks){
        return map
                (function(a){
                  switch(a[0]){
                    case 1:
                     var body = a[2], v = a[1];
                     if(caml_string_notequal(v, var$0))
                      return [1, v, substitute(var$0, tok, body)];
                     break;
                    case 2:
                     var v$0 = a[1];
                     if(caml_string_equal(v$0, var$0)) return tok;
                     break;
                    case 3:
                     var body$0 = a[1];
                     return [3, substitute(var$0, tok, body$0)];
                  }
                  return a;
                 },
                 toks);
     ...
     resolve =
       function(modl, var$0){
        var
         h = modl[1],
         _c5_ = key_index(h, var$0),
         match = caml_check_bound(h[2], _c5_)[1 + _c5_];
        if(match){
         var k1 = match[1], d1 = match[2], next1 = match[3];
         if(0 === caml_compare(var$0, k1))
          var match$0 = [0, d1];
         else if(next1){
          var k2 = next1[1], d2 = next1[2], next2 = next1[3];
          if(0 === caml_compare(var$0, k2))
           var match$0 = [0, d2];
          else if(next2){
           var k3 = next2[1], d3 = next2[2], next3 = next2[3];
           if(0 === caml_compare(var$0, k3))
            var match$0 = [0, d3];
           else{
            var param = next3;
            for(;;){
             if(param){
              ...
              if(0 !== caml_compare(var$0, k)){var param = next; continue;}
              var match$0 = [0, data];
             }
             else
              var match$0 = 0;
         ...
         var match$0 = 0;
        if(! match$0)
         throw caml_maybe_attach_backtrace([0, Undefined_var, var$0], 1);
        var value = match$0[1];
        return [3, value];
       },
     rename =
       function(modl, var$0, a){
        switch(a[0]){
          case 1:
           var
            body = a[2],
            var2 = a[1],
            _c1_ =
              map(function(_c4_){return rename(modl, var$0, _c4_);}, body),
            _c2_ = caml_string_equal(var$0, var2) ? symbol(var2, _co_) : var2;
           return [1, _c2_, _c1_];
          case 2:
           var var2$0 = a[1];
           if(caml_string_equal(var$0, var2$0))
            return [2, symbol(var2$0, _cp_)];
           break;
          case 3:
           var ptoks = a[1];
           return [3,
                   map
                    (function(_c3_){return rename(modl, var$0, _c3_);}, ptoks)];
        }
        return a;
       },
     int$0 =
       function(n){
        return 0 === n ? _cq_ : [0, _cr_, [0, [3, int$0(n - 1 | 0)], 0]];
       },
     interpret =
       function(modl, param){
        var param$0 = param;
         ...
         if(1 === f[0]){
          ...
          if(match){
           var
            ts$0 = match[2],
            tk = match[1],
            res$1 = eval$0(modl, [3, [0, f, [0, tk, 0]]]),
            param$0 = symbol$0(res$1, ts$0);
           continue;
          }
         }
         var ts = param$0[2], res = eval$0(modl, f);
         if(! res){var param$0 = ts; continue;}
         if(res[2]){
          if(caml_equal(res, [0, f, 0])) return [0, f, interpret(modl, ts)];
          var param$0 = symbol$0(res, ts);
          continue;
         }
         var res$0 = res[1];
         if(caml_equal(res$0, f)) return [0, res$0, interpret(modl, ts)];
         var param$0 = [0, res$0, ts];
        }
       },
     eval$0 =
       function(modl, t){
        switch(t[0]){
          case 0:
           var
            ...
            name = t[1],
            h = modl[1],
            i$1 = key_index(h, name),
            l$3 = caml_check_bound(h[2], i$1)[1 + i$1],
            slot = l$3;
           for(;;){
            if(slot){
             var k = slot[1], next$0 = slot[3];
             if(0 !== caml_compare(k, name)){var slot = next$0; continue;}
             slot[1] = name;
             slot[2] = body;
             var _cX_ = 0;
            }
            ...
            var switch$0 = 0;
            if(_cX_){
             caml_check_bound(h[2], i$1)[1 + i$1] = [0, name, body, l$3];
             h[1] = h[1] + 1 | 0;
             if(h[2].length - 1 << 1 < h[1]){
              var
               ...
               nsize$0 = osize * 2 | 0;
              if(nsize$0 < max_array_length){
               var
                ndata = caml_make_vect(nsize$0, 0),
                _cP_ = h.length - 1 < 4 ? 1 : 0,
                _cQ_ = _cP_ || (h[4] < 0 ? 1 : 0),
                inplace = 1 - _cQ_;
               h[2] = ndata;
               var
               ...
               if(_cS_ >= 0){
                ...
                for(;;){
                 ...
                 for(;;){
                  ...
                  var _cW_ = i$0 + 1 | 0;
                  if(_cS_ !== i$0){var i$0 = _cW_; continue a;}
                  break;
                 }
                 break;
                }
          ...
          case 1:
           return [0, t, 0];
          case 2:
           var var$0 = t[1]; return [0, resolve(modl, var$0), 0];
          case 3:
           var ptoks = t[1];
           if(ptoks){
            var _cY_ = ptoks[1];
            if(1 === _cY_[0]){
             var _cZ_ = ptoks[2];
             if(_cZ_ && ! _cZ_[2]){
              var tok = _cZ_[1], body$0 = _cY_[2], var$1 = _cY_[1];
              if(2 !== tok[0])
               return substitute(var$1, rename(modl, var$1, tok), body$0);
              var bound_var = tok[1];
              return substitute(var$1, resolve(modl, bound_var), body$0);
             }
            }
           }
           return interpret(modl, ptoks);
          case 4:
           var i$2 = t[1];
           return [0, [1, _cv_, [0, [1, _cu_, int$0(i$2)], 0]], 0];
          default:
           var
            s = t[1],
            seq = to_seq(s),
           ...
           for(;;){
            ...
            var accu$2 = accu, l$0 = accu$0;
            for(;;){
             if(! l$0) return [0, accu$2, _c0_];
             var
              l$1 = l$0[2],
              a$0 = l$0[1],
              accu$3 = [1, _ct_, [0, _cs_, [0, a$0, [0, accu$2, 0]]]],
              accu$2 = accu$3,
              l$0 = l$1;
            }
           }
     ...
     Error = [248, _cw_, caml_fresh_oo_id(0)],
     exn = [0, Error, [0]],
    ...
    var
     ...
     get$0 = function(x, f){return x == no_handler ? caml_call1(f, 0) : x;},
     true$0 = true,
     false$0 = false;
    global.String;
    global.RegExp;
          ...
          callback =
            function(e){
             ...
             return function(_cN_, _cO_){
              return caml_js_call(_cM_, _cN_, _cO_);};
            };
          ...
          _cL_ =
            concat
             (_cD_,
              map
               (tok_to_str,
                interpret(modl, parse(default_setts, to_seq(str)(0)))));
         return _cL_;
        }
        catch(exn$0){
         var exn = caml_wrap_exception(exn$0);
         if(exn === Unbalanced_parens) return _cx_;
         if(exn === Unfinished_fun) return _cy_;
         if(exn === Unfinished_str) return _cz_;
         if(exn === Bad_int) return _cA_;
         if(exn[1] !== Undefined_var) return _cC_;
         var var$0 = exn[2];
         return symbol(_cB_, var$0);
        }
       },
     onload =
       function(param){
        function _cJ_(param){
         throw caml_maybe_attach_backtrace([0, Assert_failure, _cE_], 1);
        }
        var parent = get$0(document.getElementById("history"), _cJ_);
        function _cK_(param){
         throw caml_maybe_attach_backtrace([0, Assert_failure, _cF_], 1);
        }
        var interp = get$0(document.getElementById("interpreter"), _cK_);
        interp.focus();
        string_run(default_modl, std_lib);
        addEventListener
         (interp,
          keydown,
          handler
           (function(t14){
             ...
             if(13 === match){
              var
               x = interp.textContent,
               match$0 = x == no_handler ? 0 : [0, x];
              if(match$0){
               var
                s = match$0[1],
                res = string_run(default_modl, caml_string_of_jsstring(s)),
                text =
                  "> ".concat(s, caml_jsstring_of_string(symbol(_cG_, res))),
